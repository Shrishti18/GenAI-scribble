...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-2 sm:p-6 pt-6 bg-black">
      <div className="container mx-auto flex flex-col gap-1 md:flex-row md:gap-0 xl:justify-center">
        <form
          className="flex flex-col gap-2 w-full md:w-1/2 lg:w-1/3 2xl:w-1/4"
          onSubmit={handleSubmit(async (formData) => {
        ...
        >
          ...
          <ReactSketchCanvas
            ...
            className="cursor-cell"
          />
          <button className="rounded cursor-pointer py-2 px-3 text-white font-semibold transition-transform duration-300 hover:scale-105">
            Submit
          </button>
          <button
            type="button"
            className="rounded cursor-pointer py-2 px-3 text-white font-semibold mt-3 transition-transform duration-300 hover:scale-105"
            onClick={() => {
              canvasRef.current?.clearCanvas();
              setPromptInput("");
            }}
